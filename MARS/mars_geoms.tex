...
\begin{itemize}
  ...
  \item Chord: $c$ (variable parameter; default \SI{0.22}{m}).
...
= 0.06\,c$ above the rotation plane. For $c = \SI{0.22}{m}$, the
maximum thickness is $t_\mathrm{max} = \SI{26.4}{mm}$ and
$z_\mathrm{blade} = \SI{13.2}{mm}$.
...
Blade chord            & $c$                           & \SI{0.22}{m} \\
Max blade thickness    & $0.12\,c$                     & \SI{26.4}{mm} \\
...
Blade planform area (one) & $R \times c$               & \SI{0.352}{m^2} \\
Total blade area ($N$ blades) & $N R c$                & \SI{2.816}{m^2} \\
...
$c = \SI{0.22}{m}$, $h_\mathrm{disk} = \SI{5}{mm}$.}
...
(\SI{26.4}{mm} vs.\ \SI{5}{mm} for default parameters). In the
\SI{5}{mm} radial gap, the blade blockage ratio is 5.3 (the blade is
...
$c$  & Blade chord & \SI{0.22}{m} & A only \\
